...
This command does not upgrade di-cli itself. Users run
``pipx upgrade di-cli`` (or the equivalent in their package manager)
to receive new code and skills, then ``di update`` to re-sync the
filesystem.

See docs/specs/2026-05-15-di-cli-architecture.md § Commands (update).
"""
