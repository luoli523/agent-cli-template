"""``di version`` — show di-cli version and runtime info.
...
from di.contracts import Envelope, RiskClass
from di.manifest import CommandSpec, register
from di.runtime import LOCAL_IDENTITY, emit_success

NAME = "version"
SUMMARY = "Show di-cli version and runtime info"
