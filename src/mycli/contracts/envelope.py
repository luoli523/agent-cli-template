"""Standard success and error envelopes written by every mycli-cli command.
...
See docs/specs/2026-05-15-mycli-cli-architecture.md § Output envelope.
"""
...
from mycli.contracts.error_type import ErrDetail
